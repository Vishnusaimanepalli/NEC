...
public class lec7 {
    ...
    public static void stateOfWakanda4(int[][] arr) { // diagonals of full matrix
        int n = arr.length, m = arr[0].length;
    ...
    public static void rotate2D90Deg(int[][] arr) {
        int n = arr.length, m = arr[0].length, si = 0, ei = m - 1;
